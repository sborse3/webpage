...
export const RESUME_DATA: ResumeData = {
  ...
  patents: [
    { title: "Occlusion resolving gated mechanism for sensor fusion", status: "Granted" },
    { title: "Adaptive human instance segmentation with stereo view consistency", status: "Granted" },
    ...
    { title: "Blended output generation in generative artificial intelligence models", status: "Filed" },
    { title: "Processing point-cloud data", status: "Filed" },
    { title: "Training-free machine learning model adapter transfer", status: "Filed" },
    { title: "Contextually consistent depth map", status: "Filed" },
    { title: "Polyline estimation", status: "Filed" },
    { title: "Generative models for handling occlusions", status: "Filed" },
    { title: "Sparse high rank adapters and their hardware-software co-design", status: "Filed" },
    { title: "Personalized open-vocabulary semantic segmentation for images", status: "Filed" },
    { title: "Distributing prompt processing in generative artificial intelligence models", status: "Filed" },
    { title: "Low-rank adapters for weather conditions in 3d object tracking", status: "Filed" },
    { title: "Frequency-domain machine learning model adapters", status: "Filed" },
    { title: "Open vocabulary image segmentation", status: "Filed" },
    { title: "Distillation for guided diffusion models", status: "Filed" },
    { title: "Hardware-aware efficient architectures for text-to-image diffusion models", status: "Filed" },
    { title: "Training objectives for distilling guided diffusion models", status: "Filed" },
    { title: "Control neural network inference and training based on distilled guided diffusion models", status: "Filed" },
    { title: "Test-time self-supervised guidance for diffusion models", status: "Filed" },
    { title: "Instance segmentation with depth and boundary losses", status: "Filed" },
    { title: "Depth completion using image and sparse depth inputs", status: "Filed" },
    { title: "Dynamic delta transformations for segmentation", status: "Filed" },
    { title: "Regenerative learning to enhance dense prediction", status: "Filed" },
    { title: "Intermodal sensor training", status: "Filed" },
    { title: "Modeling consistency in modalities of data for semantic segmentation", status: "Filed" },
    { title: "Feature conditioned output transformer for generalizable semantic segmentation", status: "Filed" },
    { title: "Online test time adaptive semantic segmentation with augmentation consistency", status: "Filed" },
    { title: "Cross-task distillation to improve depth estimation", status: "Filed" },
    { title: "Hierarchical supervised training for neural networks", status: "Filed" },
    { title: "Distance-based boundary aware semantic segmentation", status: "Filed" },
  ],
  projects: [
    {
